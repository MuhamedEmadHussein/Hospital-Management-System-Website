                ...
                <form action="{{ route('doctors.update', 'test') }}" method="post" autocomplete="off"
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <select multiple="multiple" class="testselect2" name="appointments[]">
                                    @foreach ($appointments as $appointment)
                                        @php $check = []; @endphp
                                        @foreach ($doctor->doctors_appointments_pivot as $key => $appointmentDOC)
                                            @php
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="number_of_statements" value="{{ $doctor->number_of_statements }}" type="number">
                            </div>
                        </div>
