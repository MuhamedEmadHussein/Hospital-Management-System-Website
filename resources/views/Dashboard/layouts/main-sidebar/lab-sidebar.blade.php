...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard.lab_employee') }}"><svg
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('lab_invoices.index') }}">قائمة الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('lab.completedInvoices') }}">قائمة الكشوفات المكتملة</a>
                    </li>
                </ul>
            </li>
        </ul>
