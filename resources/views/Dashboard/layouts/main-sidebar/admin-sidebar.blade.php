<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        <li class="side-item side-item-category">{{ trans('Dashboard/main-sidebar_trans.Main') }}
        </li>
        <li class="slide">
            <a class="side-menu__item" href="{{ route('dashboard.admin') }}"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><span class="side-menu__label">{{ trans('Dashboard/main-sidebar_trans.index') }}</span></a>
        </li>
        ...
        </svg><span class="side-menu__label">Icons</span><span class="badge badge-danger side-badge">New</span></a>
        </li> --}}
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('categories.index') }}">{{ trans('Dashboard/main-sidebar_trans.view_all') }}</a>
                </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="{{ route('group_invoices') }}">فاتورة مجموعة خدمات</a>
                </li>
            </ul>
        </li>
        <li class="slide">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="{{ url('/' . ($page = 'form-advanced')) }}">قائمة
                        الكشوفات</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('lab_employee.index') }}">قائمة الموظفين
                    </a></li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('appointments.list') }}">قائمة المواعيد</a></li>
                <li><a class="slide-item" href="{{ route('appointments.approved') }}">قائمة المواعيد المؤكده</a></li>
