    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('dashboard.doctor') }}"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><span class="side-menu__label">{{ trans('Dashboard/main-sidebar_trans.index') }}</span>
            </a>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('ray_employee.invoices') }}">قائمة الكشوفات</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'products')) }}">Products</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'product-details')) }}">Product-Details</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'product-cart')) }}">Cart</a>
                </li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'cards')) }}">Cards</a>
                </li>
                ...
                <li><a class="slide-item" href="{{ url('/' . ($page = 'calendar')) }}">Calendar</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'contacts')) }}">Contacts</a>
                </li>
                ...
                <li><a class="slide-item"
                        href="{{ url('/' . ($page = 'widget-notification')) }}">Widget-notification</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'treeview')) }}">Treeview</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'alerts')) }}">Alerts</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'avatar')) }}">Avatar</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'breadcrumbs')) }}">Breadcrumbs</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'buttons')) }}">Buttons</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'badge')) }}">Badge</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'dropdown')) }}">Dropdown</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'thumbnails')) }}">Thumbnails</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'list-group')) }}">List
                        Group</a></li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'navigation')) }}">Navigation</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'images')) }}">Images</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'pagination')) }}">Pagination</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'popover')) }}">Popover</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'progress')) }}">Progress</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'spinners')) }}">Spinners</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'media-object')) }}">Media
                        Object</a></li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'typography')) }}">Typography</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'tooltip')) }}">Tooltip</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'toast')) }}">Toast</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'tags')) }}">Tags</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'tabs')) }}">Tabs</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'accordion')) }}">Accordion</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'carousel')) }}">Carousel</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'collapse')) }}">Collapse</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'modals')) }}">Modals</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'timeline')) }}">Timeline</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'sweet-alert')) }}">Sweet
                        Alert</a></li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'rating')) }}">Ratings</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'counters')) }}">Counters</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'search')) }}">Search</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'userlist')) }}">Userlist</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'blog')) }}">Blog</a>
                </li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'mail')) }}">Mail</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-compose')) }}">Mail
                        Compose</a></li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-read')) }}">Read-mail</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-settings')) }}">mail-settings</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'chat')) }}">Chat</a>
                </li>
            </ul>
        </li>
        <li class="slide">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="{{ url('/' . ($page = 'faq')) }}">Faqs</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'empty')) }}">Empty
                        Page</a></li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="{{ url('/' . ($page = 'border')) }}">Border</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'display')) }}">Display</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'flex')) }}">Flex</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'height')) }}">Height</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'margin')) }}">Margin</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'padding')) }}">Padding</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'position')) }}">Position</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'width')) }}">Width</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'extras')) }}">Extras</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ url('/' . ($page = 'signin')) }}">Sign
                        In</a></li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'signup')) }}">Sign
                        Up</a></li>
                ...
                <li><a class="slide-item" href="{{ url('/' . ($page = '404')) }}">404
                        Error</a></li>
                <li><a class="slide-item" href="{{ url('/' . ($page = '500')) }}">500
                        Error</a></li>
            </ul>
        </li>
        <li class="slide ">
