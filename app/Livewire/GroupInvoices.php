        ...
        if($this->type == 1){
            ...
            try {
                ...
                if($this->updateMode){
                    ...
                    $group_invoices->category_id = DB::table('category_translations')->where('name', $this->section_id)->first()->category_id;
...
//----------------------------------------------------------------------------------------------------
    ...
    public function edit($id){
        ...
        $this->section_id = DB::table('category_translations')->where('id', $group_invoices->category_id)->first()->name;
