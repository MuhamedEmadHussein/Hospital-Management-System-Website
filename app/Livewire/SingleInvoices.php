...
class SingleInvoices extends Component
{
    ...
    {
        $doctor_id = Doctor::with('category')->where('id', $this->doctor_id)->first();
        $this->section_id = $doctor_id->category->name;
    ...
    public function edit($id){
        ...
        $this->section_id = DB::table('category_translations')->where('id', $single_invoice->category_id)->first()->name;
        ...
        if($this->type == 1){
            ...
            try{
                ...
                if($this->updateMode){
                    ...
                    $single_invoices->category_id = DB::table('category_translations')->where('name', $this->section_id)->first()->category_id;
                    ...
                    Notification::create([
                        ...
                        'message' =>  'كشف جديد: ' . Patient::find($this->patient_id)->name
                    ]);
    ...
    public function print($id)
    {
        ...
        return Redirect::route('Print_single_invoices',[
            ...
            'section_id' => $single_invoice->Category->name,
