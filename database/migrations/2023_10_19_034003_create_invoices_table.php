...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->foreignId('Group_id')->nullable()->references('id')->on('groups')->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('Service_id')->nullable()->references('id')->on('services')->cascadeOnDelete()->cascadeOnUpdate();
